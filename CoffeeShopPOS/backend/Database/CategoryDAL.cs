...
namespace CoffeeShopPOS.Database
{
    ...
    public static class CategoryDAL
    {
        ...
        /// Returns the auto-generated category_id from PostgreSQL.
        /// </summary>
        public static int Insert(Category category)
        {
            ...
            // ExecuteScalar returns the new category_id via RETURNING
        ...
        {
            string query = "UPDATE categories SET is_active = false WHERE category_id = @id";
            var parameters = new Dictionary<string, object?> { { "@id", categoryId } };
