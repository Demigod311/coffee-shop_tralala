...
// It reads the MySQL connection string from appsettings and provides reusable methods
...
namespace CoffeeShopPOS.Database
{
    ...
    public static class DbHelper
    {
        ...
        private static string _connectionString =
            "Server=localhost;Port=3306;Database=coffee_shop_pos;Uid=root;Pwd=sklegend@3196;SslMode=None;";
        ...
        /// </summary>
        /// <returns>An open MySqlConnection to the coffee_shop_pos database.</returns>
        public static MySqlConnection GetConnection()
        {
            ...
            try
            {
                connection.Open();  // Attempt to connect to MySQL
                return connection;
            }
            catch (MySqlException ex)
            {
                // Provide a clear error message if MySQL is not running or credentials are wrong
                throw new Exception(
        ...
        /// <summary>
        /// Executes a query that returns a single scalar value (e.g., COUNT, MAX, LAST_INSERT_ID).
        ...
        /// <summary>
        /// Executes a query and returns a MySqlDataReader for reading multiple rows.
        ...
        private static void AddParameters(MySqlCommand command, Dictionary<string, object?>? parameters)
        {
            ...
            {
                // Convert C# null to DBNull.Value for proper MySQL handling
